...
class vegRecipes extends StatefulWidget {
  @override
  _vegRecipesState createState() => _vegRecipesState();
}

class _vegRecipesState extends State<vegRecipes> {
String recipeURL = "https://api.spoonacular.com/recipes/random?number=30&tags=vegetarian&apiKey=a7fa14d84b6546c6b9426be7e6f11000";
List? listResponse;
Map? mapResponse;
List? listOfResults;
...
Widget build(BuildContext context) {
  return Scaffold(
               appBar: AppBar(
            title:Text('Vegetarian recipes to try!',
              style: TextStyle(
              fontFamily: 'Fredoka',
              ),
              ),            leading: MenuWidget(),

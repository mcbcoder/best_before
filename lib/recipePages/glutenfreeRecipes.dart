...
class glutenfreeRecipes extends StatefulWidget {
  @override
  _glutenfreeRecipesState createState() => _glutenfreeRecipesState();
}

class _glutenfreeRecipesState extends State<glutenfreeRecipes> {
String recipeURL = "https://api.spoonacular.com/recipes/random?number=30&diet=glutenfree&apiKey=a7fa14d84b6546c6b9426be7e6f11000";
List? listResponse;
Map? mapResponse;
List? listOfResults;
...
Widget build(BuildContext context) {
  return Scaffold(
               appBar: AppBar(
            title:Text('Gluten Free recipes to try',
              style: TextStyle(
              fontFamily: 'Fredoka',
              ),
              ),

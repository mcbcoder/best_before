...
class breakfastRecipes extends StatefulWidget {
  @override
  _breakfastRecipesState createState() => _breakfastRecipesState();
}

class _breakfastRecipesState extends State<breakfastRecipes> {
String recipeURL = "https://api.spoonacular.com/recipes/random?number=30&tags=breakfast&apiKey=a7fa14d84b6546c6b9426be7e6f11000";
List? listResponse;
Map? mapResponse;
List? listOfResults;
String? id;
...
Widget build(BuildContext context) {
  return Scaffold(
               appBar: AppBar(
            title:Text('Breakfast recipes to try',
              style: TextStyle(
              fontFamily: 'Fredoka',
              ),
              ),

...
class veganRecipes extends StatefulWidget {
  @override
  _veganRecipesState createState() => _veganRecipesState();
}

class _veganRecipesState extends State<veganRecipes> {
...
Widget build(BuildContext context) {
  return Scaffold(
               appBar: AppBar(
            title:Text('Vegan recipes to try!',
              style: TextStyle(
              fontFamily: 'Fredoka',
              ),
              ),

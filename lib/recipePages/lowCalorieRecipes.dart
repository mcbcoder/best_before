...
class lowCalorieRecipes extends StatefulWidget {
  @override
  _lowCalorieRecipesState createState() => _lowCalorieRecipesState();
}

class _lowCalorieRecipesState extends State<lowCalorieRecipes> {
String recipeURL = "https://api.spoonacular.com/recipes/random?number=30&maxCalories=700&apiKey=a7fa14d84b6546c6b9426be7e6f11000";
List? listResponse;
Map? mapResponse;
List? listOfResults;
...
Widget build(BuildContext context) {
  return Scaffold(
               appBar: AppBar(
            title:Text('Recipes below 700 calories',
              style: TextStyle(
              fontFamily: 'Fredoka',
              ),
              ),

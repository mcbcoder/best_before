...
class lunchRecipes extends StatefulWidget {
  @override
  _lunchRecipesState createState() => _lunchRecipesState();
}

class _lunchRecipesState extends State<lunchRecipes> {
String recipeURL = "https://api.spoonacular.com/recipes/random?number=30&tags=dinner&apiKey=a7fa14d84b6546c6b9426be7e6f11000";
List? listResponse;
Map? mapResponse;
List? listOfResults;
...
Widget build(BuildContext context) {
  return Scaffold(
               appBar: AppBar(
            title:Text('Lunch & Dinner recipes to try',
              style: TextStyle(
              fontFamily: 'Fredoka',
              ),
              ),

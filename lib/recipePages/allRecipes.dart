...
String recipeURL = "https://api.spoonacular.com/recipes/complexSearch/?apiKey=a7fa14d84b6546c6b9426be7e6f11000";
List? listResponse;
Map? mapResponse;
List? listOfResults;
...
Widget build(BuildContext context) {
  return Scaffold(
    ...
    mapResponse==null?Container(): SingleChildScrollView(
      ...
      children: <Widget> [
      Text(
      mapResponse!['totalResults'].toString(),
                    ...
                    children: [
                      ...
                      Text(
                           //CALORIES IS FETCHED FROM API
                            listOfResults![index]['calories'].toString(),
                            style: TextStyle(
                            color: Colors.white.withOpacity(1.0)),
                      ),
                    ],

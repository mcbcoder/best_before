...
class tobeusedRecipe extends StatefulWidget {
  @override
  _tobeusedRecipeState createState() => _tobeusedRecipeState();
}

class _tobeusedRecipeState extends State<tobeusedRecipe> {
String recipeURL = "https://api.spoonacular.com/recipes/random?number=30&tags=vegan&apiKey=a7fa14d84b6546c6b9426be7e6f11000";
List? listResponse;
Map? mapResponse;
List? listOfResults;
...
Widget build(BuildContext context) {
  return Scaffold(
               appBar: AppBar(
            title:Text('Recipes to use ingredients expiring soon',
              style: TextStyle(
              fontFamily: 'Fredoka',
              ),
              ),

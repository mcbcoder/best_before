...
class pescetarianRecipes extends StatefulWidget {
  @override
  _pescetarianRecipesState createState() => _pescetarianRecipesState();
}

class _pescetarianRecipesState extends State<pescetarianRecipes> {
String recipeURL = "https://api.spoonacular.com/recipes/random?number=30&tags=pescetarian&apiKey=a7fa14d84b6546c6b9426be7e6f11000";
List? listResponse;
Map? mapResponse;
List? listOfResults;
...
Widget build(BuildContext context) {
  return Scaffold(
               appBar: AppBar(
            title:Text('Pescetarian recipes to try',
              style: TextStyle(
              fontFamily: 'Fredoka',
              ),
              ),
